...
public class SongDetailActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("SongDetailActivity2", "onCreate()");
        setContentView(R.layout.activity_song_detail);
        initView();
        getIntentData();

        Intent intent = new Intent(SongDetailActivity2.this, MyMusicService.class);
        startService(intent);
    ...
    protected void onResume() {
        super.onResume();
        Log.e("SongDetailActivity2", "onResume()");
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        getIntentData();
        Log.e("SongDetailActivity2", "onNewIntent(), index:"+currentIndex);
        //重新绑定
        bindService(intent, serviceConnection, Context.BIND_AUTO_CREATE);
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.e("SongDetailActivity2", "onDestory()");
    ...
    ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (musicControl != null) {
                ...
                //播放
                if (currentIndex == -1) {
                    Toast.makeText(SongDetailActivity2.this, "播放失败！index=-1", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                if (!from.equals("notification"))
    ...
    public static void actionStart(Context context, int index) {
        Intent intent = new Intent(context, SongDetailActivity2.class);
